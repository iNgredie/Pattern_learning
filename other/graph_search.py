...
if __name__ == '__main__':
    ...
    assert graph_search.find_path_dfs('A', 'D') == ['A', 'B', 'C', 'D']
    assert graph_search.find_path_dfs('G', 'F') == ['G', 'E', 'F']
    assert graph_search.find_path_dfs('C', 'H') is None
    assert graph_search.find_path_dfs('C', 'X') is None
    assert graph_search.find_all_paths_dfs('A', 'D') == [['A', 'B', 'C', 'D'], ['A', 'B', 'D'], ['A', 'C', 'D']]
    assert graph_search.find_shortest_path_dfs('A', 'D') == ['A', 'B', 'D']
    assert graph_search.find_shortest_path_dfs('A', 'F') == ['A', 'C', 'G', 'E', 'F']
    assert graph_search.find_shortest_path_bfs('A', 'D') == ['A', 'B', 'D']
    assert graph_search.find_shortest_path_bfs('A', 'F') == ['A', 'C', 'G', 'E', 'F']
    assert graph_search.find_shortest_path_bfs('G', 'F') == ['G', 'E', 'F']
    assert graph_search.find_shortest_path_bfs('A', 'H') is None
    assert graph_search.find_shortest_path_bfs('A', 'X') is None
