...
class Command(ABC):
    """
    Интерфейс Команды обхявляет метод для выполнения команд
    """
...
class Receiver:
    """
    Классы Получатель содержат некую важную бизнес-логику. Они умеют выполнять
...
if __name__ == '__main__':
    ...
    invoker = Invoker()
    invoker.set_on_start(SimpleCommand('Sya Hi!'))
    receiver = Receiver()
