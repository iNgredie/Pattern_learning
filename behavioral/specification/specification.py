...
if __name__ == '__main__':
    ...
    assert root_specification.is_satisfied_by(andrey) == False
    assert root_specification.is_satisfied_by(ivan) == True
    assert root_specification.is_satisfied_by(vasiliy) == False
