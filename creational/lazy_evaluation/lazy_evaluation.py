...
def lazy_property2(fn):
    ...
    then than calculated result is used the next time you access the value.
    """
...
if __name__ == '__main__':
    ...
    assert Jhon.name == 'Jhon'

    assert Jhon.occupation == 'Coder'
    assert sorted(Jhon.__dict__.items()) == [('call_count2', 0), ('name', 'Jhon'), ('occupation', 'Coder')]

    assert Jhon.relatives == 'Many relatives.'
    assert Jhon.parents == 'Father and mother'

    assert sorted(Jhon.__dict__.items()) == [
